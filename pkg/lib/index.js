...
exports.Heading = exports.HeadingLevelProvider = exports.HeadingLevelContext = void 0;
...
exports.HeadingLevelProvider = HeadingLevelProvider;

function H(_ref2) {
  var props = _extends({}, _ref2);

  var level = Math.min(6, (0, _react.useContext)(HeadingLevelContext));
...
function Section(_ref3) {
  ...
  var level = (0, _react.useContext)(HeadingLevelContext);
  return /*#__PURE__*/_react["default"].createElement(HeadingLevelContext.Provider, {
    value: level + 1
  }, children);
}